package nl.bsoft.data.graphql.config.h2;
...
public class DatabaseH2 extends DatabaseConfig {


    private PrometheusMeterRegistry prometheusMeterRegistry;

    public DatabaseH2(final PrometheusMeterRegistry prometheusMeterRegistry) {
    ...
    public void setUpHikariWithMetrics() {
        if (dataSourceH2() instanceof HikariDataSource) {
            dataSourceH2().setMetricRegistry(prometheusMeterRegistry);
        }
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryH2(@Qualifier("dataSourceH2") final DataSource dataSourceH2) throws SQLException {
        ...
        factoryBean.setPackagesToScan("nl.bsoft.data.graphql.config.h2.repo", "nl.bsoft.data.graphql.model.h2");
